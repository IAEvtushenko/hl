    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.ManyToManyField(blank=True, related_name='related_work', to='main.Media')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.AddField(
            model_name='media',
            name='work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_media', to='main.work', verbose_name='Проект'),
        ),
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(blank=True, related_name='related_order', to='main.Order', verbose_name='Заказы покупателя'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
